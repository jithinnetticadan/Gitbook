...
{% tab title="Hydra" %}
```shellscript
hydra -L users.txt -p <pass> -f <IP> pop3/imap
hydra -L users.txt -P <pass.list> -f <IP> pop3/imap
hydra -l user@example.com -P password_list.txt pop3://mail.server.com
hydra -l user@example.com -P password_list.txt imap://mail.server.com
```
{% endtab %}
