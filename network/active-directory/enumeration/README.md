...
#### Spawn a Shell using credentials obtained using above or [as-rep-roasting.md](as-rep-roasting.md "mention")

#### Understand the User Compromised

* `whoami /all`&#x20;
* _**Interesting Privileges**_
  * SeImpersonatePrivilege [#windows-privileges](../../exploitation/windows-privesc.md#windows-privileges "mention")
