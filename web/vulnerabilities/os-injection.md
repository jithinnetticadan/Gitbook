...
* Fuzz for the accepted operator initial before appending a command.
...
* `& ping -c 10 127.0.0.1 &` <sup><sub>(try using different separators<sub></sup> <sup><sub>- Linux)<sub></sup>
* `& ping -n 10 127.0.0.1 &` <sup><sub>(Windows - uses<sub></sup> <sup><sub>`-n`<sub></sup> <sup><sub>instead of<sub></sup> <sup><sub>`-c`<sub></sup><sup><sub>)<sub></sup>
